            ...
            <div className="grid md:grid-cols-2 gap-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                {projects.map((project) => (
                    <a
                        key={project.id}
                        href={project.link}
                        className="group flex flex-col gap-6 p-8 rounded-2xl border border-gray-100 dark:border-neutral-800 bg-white dark:bg-neutral-900/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                    >
                        ...
                        <div className="mt-auto pt-4 flex items-center gap-2 text-sm font-medium text-gray-500 group-hover:text-gray-900 dark:group-hover:text-gray-200 transition-colors">
                            Read Case Study
                        </div>
                    </a>
                ))}
